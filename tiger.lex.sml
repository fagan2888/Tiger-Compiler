...
STRING | STRING_IGNORE | COMMENT | INITIAL
...
fun yyAction57 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (if (Option.valOf (Int.fromString (substring (yytext,1,(size yytext)-1))))>255 then (ErrorMsg.error yypos ("illegal escape sequence " ^ yytext)) else (buildString := (!buildString) ^ (Char.toString (Char.chr (Option.valOf (Int.fromString (substring (yytext,1,(size yytext)-1))))))); continue())
      end
fun yyAction58 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING_IGNORE; continue()))
       ...
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction43(strm, yyNO_MATCH)
                  else yyQ107(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ63(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
              else yyAction43(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ115 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction0(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #" "
              then yyQ115(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
              else yyAction0(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction56(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp <= #"@"
                  then yyAction56(strm, yyNO_MATCH)
                  else yyQ10(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction53(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp <= #"@"
                  then yyAction53(strm, yyNO_MATCH)
                  else yyQ10(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
            else if inp = #"a"
       ...
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"]"
              ...
              then yyQ13(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"f"
...
in
  (case (!(yyss))
   of STRING => yyQ0(!(yystrm), yyNO_MATCH)
    | STRING_IGNORE => yyQ1(!(yystrm), yyNO_MATCH)
