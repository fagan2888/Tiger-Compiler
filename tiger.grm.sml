...
fn (i392,defaultPos,stack,
    (()):arg) =>
case (i392,stack)
of  ( 0, ( ( _, ( MlyValue.ntVOID dec1, _, dec1right)) :: ( _, ( 
...
|  ( 1, ( ( _, ( MlyValue.ntVOID tydec1, tydec1left, tydec1right)) :: 
...
|  ( 2, ( ( _, ( MlyValue.ntVOID vardec1, vardec1left, vardec1right))
 :: rest671)) => let val  result = MlyValue.ntVOID (fn _ => ( let val 
 vardec1 = vardec1 ()
 in ()
end; ()))
...
|  ( 3, ( ( _, ( MlyValue.ntVOID fundec1, fundec1left, fundec1right))
 :: rest671)) => let val  result = MlyValue.ntVOID (fn _ => ( let val 
 fundec1 = fundec1 ()
 in ()
end; ()))
...
|  ( 4, ( ( _, ( MlyValue.ntVOID ty1, _, ty1right)) :: _ :: ( _, ( 
...
|  ( 6, ( ( _, ( _, _, RBRACE1right)) :: ( _, ( MlyValue.ntVOID 
...
|  ( 7, ( ( _, ( MlyValue.ID ID1, _, ID1right)) :: _ :: ( _, ( _, 
...
|  ( 9, ( ( _, ( MlyValue.ID ID2, _, ID2right)) :: _ :: ( _, ( 
...
|  ( 15, ( ( _, ( MlyValue.ntVOID exp2, _, exp2right)) :: ( _, ( 
...
|  ( 24, ( ( _, ( _, _, END1right)) :: ( _, ( MlyValue.ntVOID exp1, _,
